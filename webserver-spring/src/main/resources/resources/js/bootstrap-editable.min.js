...
! function(a) {
    ...
    function(a) {
        ...
        }), a.fn.editableform.buttons = '<div><button type="submit" class="btn btn-light btn-sm editable-submit"><i class="fa fa-check" aria-hidden="true"></i></button><button type="button" class="btn btn-light btn-sm editable-cancel"><i class="fa fa-times" aria-hidden="true"></i></button></div>', a.fn.editableform.errorGroupClass = "has-error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs4"
    }(window.jQuery),
    function(a) {
        "use strict";
    ...
    function(a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {
            ...
            render: function() {
                this.$input.bdatepicker(this.options.datepicker), this.options.clear && (this.$clear = a('<button type="button" class="btn btn-light btn-sm editable-submit" style="width:100%; margin-top:7px">Clear</button>').html(this.options.clear).click(a.proxy(function(a) {
                    a.preventDefault(), a.stopPropagation(), this.clear()
                }, this)), this.$tpl.parent().parent().children().eq(1).append(a('<div>').append(this.$clear)))
            },
            value2html: function(a, c) {
        ...
        a.fn.bdatepicker.buttons = '<div><button type="submit" class="btn btn-light btn-sm editable-submit"><i class="fa fa-check" aria-hidden="true"></i></button><button type="button" class="btn btn-light btn-sm editable-cancel"><i class="fa fa-times" aria-hidden="true"></i></button></div><div></div>'
    }(window.jQuery),
    function(a) {
        "use strict";
        var b = function(a) {
